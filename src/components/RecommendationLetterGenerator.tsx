...
export default function RecommendationLetterGenerator() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `recommendation-letter-${candidateName}.txt`;
    ...
    <div className="flex gap-8">
      <div className="flex-1">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Generate Recommendation Letter</h2>
              <p className="text-gray-600">Create a personalized recommendation letter</p>
            </div>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="candidateName" className="block text-sm text-gray-700 mb-2">
                    Candidate Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition"
                ...
                <div>
                  <label htmlFor="relationship" className="block text-sm text-gray-700 mb-2">
                    Your Relationship
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition"
                    placeholder="e.g., Professor, Manager, Supervisor"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition"
                  placeholder="List notable achievements, skills, and qualities"
                  rows={4}
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label htmlFor="purpose" className="block text-sm text-gray-700 mb-2">
                    Letter Purpose
                  </label>
                  <select
                    id="purpose"
              ...
              <button
                ...
                className="relative w-full bg-gradient-to-r from-purple-500 to-purple-600 text-white py-4 px-6 rounded-xl hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
              >
                {loading ? (
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-purple-500 group-hover:bg-purple-500/5 transition">
                    {getCategoryIcon(category.icon)}
                  </div>
                  <span className="text-gray-900">{category.name}</span>
                </div>
                <span className="text-sm text-purple-500 bg-white px-3 py-1 rounded-lg">
                  {category.count}
                </span>
              </a>
            ))}
