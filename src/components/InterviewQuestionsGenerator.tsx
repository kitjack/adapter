...
export default function InterviewQuestionsGenerator() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `${position}-interview-questions.txt`;
    ...
    <div className="flex gap-8">
      <div className="flex-1">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Generate Interview Questions</h2>
              <p className="text-gray-600">Create tailored questions for any position</p>
            </div>
