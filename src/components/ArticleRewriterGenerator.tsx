...
export default function ArticleRewriterGenerator() {
  ...
  const handleDownload = () => {
    const content = rewrittenText.join('\n\n---\n\n');
  ...
  const handleCopy = async () => {
    try {
      await navigator.clipboard.writeText(rewrittenText.join('\n\n---\n\n'));
      setCopied(true);
    } catch (err) {
    ...
    <div className="flex gap-8">
      <div className="flex-1">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Rewrite Your Article</h2>
              <p className="text-gray-600">Transform your content with fresh phrasing while preserving meaning</p>
            </div>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="originalText" className="block text-sm text-gray-700 mb-2">
                  Original Text
                </label>
                <textarea
                  id="originalText"
