...
export default function ProductDescriptionGenerator() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `${productName.slice(0, 30)}-description.txt`;
    ...
    <div className="flex gap-8">
      <div className="flex-1">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Generate Your Product Description</h2>
              <p className="text-gray-600">Create compelling product descriptions that convert</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="features" className="block text-sm text-gray-700 mb-2">
              ...
              <div>
                <label htmlFor="targetAudience" className="block text-sm text-gray-700 mb-2">
                  Target Audience
                </label>
                <input
                  type="text"
